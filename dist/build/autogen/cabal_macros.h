...
/* package twentefp-eventloop-trees-0.1.2.3 */
#define VERSION_twentefp_eventloop_trees "0.1.2.3"
#define MIN_VERSION_twentefp_eventloop_trees(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_PACKAGE_KEY "Block_A2BV2XG7SFA4otbcNk3KfE"
